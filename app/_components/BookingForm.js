...
function BookingForm({ cabin, user }) {
	...
	return (
		<div className='scale-[1.01]'>
			<div className='bg-primary-800 text-primary-300 px-16 py-2 flex justify-between items-center object-contain'>
				<p>Logged in as</p>
			...
			<form
				className='bg-primary-900 py-10 px-16 text-lg flex gap-5 flex-col h-[24rem]'
